...
namespace Controls
{
    ...
    {
        /// <summary>
        /// 返回所有被考评人信息，包括审核意见和状态（ID, Date, Name, Sex, Department, Job, IDNo, Birthday, Telephone, Email, Fund, Character, Company, StartTime, StopTime, Status, Comment）
        /// </summary>
        ...
        public static bool GetAll(ref DataTable dt, ref string exception)
        {
            ...
            string[] values1 = new string[] { "123456", "2010-3-3", "高1", "男", "医学院", "饲养员", "1234556789012", "1989-1-2", "1300000001", "gao1@tongji.edu.cn", "学校", "劳务", "东林", "2013-7-10", "2013-8-10", "0", "" };
            string[] values2 = new string[] { "123456", "2010-3-3", "高2", "男", "医学院", "饲养员", "1234556789012", "1989-1-2", "1300000002", "gao1@tongji.edu.cn", "学校", "劳务", "东林", "2013-7-10", "2013-8-10", "0", "" };
            string[] values3 = new string[] { "123456", "2010-3-3", "高3", "男", "医学院", "饲养员", "1234556789012", "1989-1-2", "1300000001", "gao1@tongji.edu.cn", "学校", "劳务", "东林", "2013-7-10", "2013-8-10", "0", "" };
            string[] values4 = new string[] { "123456", "2010-3-3", "高4", "男", "医学院", "饲养员", "1234556789012", "1989-1-2", "1300000001", "gao1@tongji.edu.cn", "学校", "劳务", "东林", "2013-7-10", "2013-8-10", "0", "" };
        ...
        /// <summary>
        /// 根据部门返回所有被考评人信息，包括审核意见和状态（ID, Date, Name, Sex, Department, Job, IDNo, Birthday, Telephone, Email, Fund, Character, Company, StartTime, StopTime, Status, Comment）
        /// </summary>
        /// <param name="dt">包含所需信息的表</param>
