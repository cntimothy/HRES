...
namespace Controls
{
    public static class PostBookManagementCtrl
    {
        ...
        public static bool GetAll(ref DataTable dt, ref string exception)
        {
            ...
            string[] values1 = new string[] { "11", "高1", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "0", "" };
            string[] values2 = new string[] { "12", "高2", "男", "上海黄渡同济人力资源有限公司", "材料学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "0", "" };
            string[] values3 = new string[] { "13", "高3", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "0", "" };
            string[] values4 = new string[] { "14", "高4", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "0", "" };
            string[] values5 = new string[] { "15", "高5", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "0", "" };
            string[] values6 = new string[] { "16", "高6", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "0", "" };
            string[] values7 = new string[] { "17", "高7", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "0", "" };
            string[] values8 = new string[] { "18", "高8", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "0", "" };
            string[] values9 = new string[] { "19", "高9", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "0", "" };
            string[] values10 = new string[] { "20", "高10", "男", "上海市东凌国际人才有限公司", "电信学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "0", "test for comment" };
            string[] values11 = new string[] { "21", "高11", "男", "上海市东凌国际人才有限公司", "电信学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "0", "" };
            string[] values12 = new string[] { "22", "高12", "男", "上海市东凌国际人才有限公司", "电信学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "0", "" };
            string[] values13 = new string[] { "23", "高13", "男", "上海市东凌国际人才有限公司", "电信学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "1", "" };
            string[] values14 = new string[] { "24", "高14", "男", "上海市东凌国际人才有限公司", "电信学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "1", "test for comment" };
            string[] values15 = new string[] { "25", "高15", "男", "上海市东凌国际人才有限公司", "电信学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "1", "" };
            string[] values16 = new string[] { "26", "高16", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "1", "" };
            string[] values17 = new string[] { "27", "高17", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "1", "" };
            string[] values18 = new string[] { "28", "高18", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "1", "" };
            string[] values19 = new string[] { "29", "高19", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "1", "" };
            string[] values20 = new string[] { "30", "高20", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "2", "" };
            string[] values21 = new string[] { "31", "高21", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "2", "" };
            string[] values22 = new string[] { "32", "高22", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "3", "" };
            string[] values23 = new string[] { "33", "高23", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "3", "" };
            string[] values24 = new string[] { "34", "高24", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "4", "" };
            string[] values25 = new string[] { "35", "高25", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "4", "" };
            dt.Rows.Add(values1);
            dt.Rows.Add(values2);
            dt.Rows.Add(values3);
            dt.Rows.Add(values4);
        ...
        public static bool GetAllByDepart(ref DataTable dt, string depart, ref string exception)
        {
            ...
            string[] values8 = new string[] { "18", "高8", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "0", "" };
            string[] values9 = new string[] { "19", "高9", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "0", "" };
            string[] values10 = new string[] { "20", "高10", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "0", "test for comment" };
            string[] values11 = new string[] { "21", "高11", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "0", "" };
            string[] values12 = new string[] { "22", "高12", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "0", "" };
            string[] values13 = new string[] { "23", "高13", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "1", "" };
            string[] values14 = new string[] { "24", "高14", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "1", "test for comment" };
            string[] values15 = new string[] { "25", "高15", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "1", "" };
            string[] values16 = new string[] { "26", "高16", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "1", "" };
            string[] values17 = new string[] { "27", "高17", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "1", "" };
            string[] values18 = new string[] { "28", "高18", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "1", "" };
            string[] values19 = new string[] { "29", "高19", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "教师", "学校", "人才", "2013-9", "2013-11", "1", "" };
        ...
        /// <summary>
        /// 获取已提交岗位责任书的被考评人的姓名id字典，不为空返回true，否则返回false
        /// </summary>
