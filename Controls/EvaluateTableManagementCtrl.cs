...
namespace Controls
{
    public static class EvaluateTableManagementCtrl
    {
        ...
        public static bool GetEvaluateTable(string ID, ref EvaluateTable evaluateTable, ref string exception)
        {
            ...
            Quota quota1 = new Quota("发展团队1", new string[] { "在团队中是自然的核心人物，任何情况下都能够激励团队，带领团队达成目标", "易于与他人沟通，积极促进团队协作，并能引导团队达到组织目标", "能够根据要求努力促进团队的协作和沟通，使工作顺利开展", "能够与他人合作，努力协调，不会影响工作" }, "0");
            Quota quota2 = new Quota("发展团队2", new string[] { "在团队中是自然的核心人物，任何情况下都能够激励团队，带领团队达成目标", "易于与他人沟通，积极促进团队协作，并能引导团队达到组织目标", "能够根据要求努力促进团队的协作和沟通，使工作顺利开展", "能够与他人合作，努力协调，不会影响工作" }, "0");
            Quota quota3 = new Quota("发展团队3", new string[] { "在团队中是自然的核心人物，任何情况下都能够激励团队，带领团队达成目标", "易于与他人沟通，积极促进团队协作，并能引导团队达到组织目标", "能够根据要求努力促进团队的协作和沟通，使工作顺利开展", "能够与他人合作，努力协调，不会影响工作" }, "0");
            Quota quota4 = new Quota("发展团队4", new string[] { "在团队中是自然的核心人物，任何情况下都能够激励团队，带领团队达成目标", "易于与他人沟通，积极促进团队协作，并能引导团队达到组织目标", "能够根据要求努力促进团队的协作和沟通，使工作顺利开展", "能够与他人合作，努力协调，不会影响工作" }, "0");
            ...
            Quota reject1 = new Quota("否决指标", new string[] { "严重失职，营私舞弊，给本单位造成3000元以上经济损失或者其它严重后果的" }, "0");
            Quota reject2 = new Quota("否决指标", new string[] { "严重失职，营私舞弊，给本单位造成3000元以上经济损失或者其它严重后果的" }, "0");
            Quota reject3 = new Quota("否决指标", new string[] { "严重失职，营私舞弊，给本单位造成3000元以上经济损失或者其它严重后果的" }, "0");
            Quota reject4 = new Quota("否决指标", new string[] { "严重失职，营私舞弊，给本单位造成3000元以上经济损失或者其它严重后果的" }, "0");
            evaluateTable.Regect.Add(reject1);
            evaluateTable.Regect.Add(reject2);
            evaluateTable.Regect.Add(reject3);
            evaluateTable.Regect.Add(reject4);
