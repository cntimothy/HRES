...
namespace Controls
{
    public static class EvaluateTableManagementCtrl
    {
        ...
        public static bool GetAll(ref DataTable dt, ref string exception)
        {
            ...
            string[] values10 = new string[] { "20", "高10", "男", "上海市东凌国际人才有限公司", "电信学院", "教务处", "人事助理", "管理", "学校", "人才", "2013-9", "2013-11", "0", "test for comment" };
            string[] values11 = new string[] { "21", "高11", "男", "上海市东凌国际人才有限公司", "电信学院", "教务处", "人事助理", "管理", "学校", "人才", "2013-9", "2013-11", "0", "" };
            string[] values12 = new string[] { "22", "高12", "男", "上海市东凌国际人才有限公司", "电信学院", "教务处", "人事助理", "管理", "学校", "人才", "2013-9", "2013-11", "0", "" };
            string[] values13 = new string[] { "23", "高13", "男", "上海市东凌国际人才有限公司", "电信学院", "教务处", "人事助理", "管理", "学校", "人才", "2013-9", "2013-11", "1", "" };
            string[] values14 = new string[] { "24", "高14", "男", "上海市东凌国际人才有限公司", "电信学院", "教务处", "人事助理", "管理", "学校", "人才", "2013-9", "2013-11", "1", "test for comment" };
            string[] values15 = new string[] { "25", "高15", "男", "上海市东凌国际人才有限公司", "电信学院", "教务处", "人事助理", "管理", "学校", "人才", "2013-9", "2013-11", "1", "" };
        ...
        public static bool GetAllByDepart(ref DataTable dt, string depart, ref string exception)
        {
            ...
            string[] values3 = new string[] { "13", "高3", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "管理", "学校", "人才", "2013-9", "2013-11", "0", "" };
            string[] values4 = new string[] { "14", "高4", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "管理", "学校", "人才", "2013-9", "2013-11", "0", "" };
            string[] values5 = new string[] { "15", "高5", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "管理", "学校", "人才", "2013-9", "2013-11", "5", "" };
            string[] values6 = new string[] { "16", "高6", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "管理", "学校", "人才", "2013-9", "2013-11", "5", "" };
            string[] values7 = new string[] { "17", "高7", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "管理", "学校", "人才", "2013-9", "2013-11", "0", "" };
            string[] values8 = new string[] { "18", "高8", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "管理", "学校", "人才", "2013-9", "2013-11", "0", "" };
            string[] values9 = new string[] { "19", "高9", "男", "上海市东凌国际人才有限公司", "材料学院", "教务处", "人事助理", "管理", "学校", "人才", "2013-9", "2013-11", "0", "" };
