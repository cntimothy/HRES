...
<body>
    ...
    <x:Grid ID="Grid1" Title="指标库" PageSize="20" ShowBorder="true" ShowHeader="true"
        AllowPaging="true" runat="server" CssStyle="width:100%" DataKeyNames="Level1,Level2,Quota1,Quota2,Quota3,Quota4"
        ...
        <Columns>
            ...
            <x:LinkButtonField HeaderText="操作;" ExpandUnusedSpace="true" Width="100px" ConfirmText="确定删除？" ConfirmTarget="Top"
                CommandName="Delete" Text="删除" />
        </Columns>
    </x:Grid>
    <x:Window ID="Window_NewQuota" runat="server" BodyPadding="5px" IsModal="true"
        IFrameUrl="about:blank" EnableMaximize="false" EnableIFrame="true" Popup="false"
        Title="新指标" CssStyle="width:80%" Height="400px" OnClose="Window_NewQuota_Close">
    </x:Window>
    </form>
</body>
</html>
