<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckEvaluateTable.aspx.cs" Inherits="HRES.Pages.EvaluateTableManagement.CheckEvaluateTable" %>
                ...
                <Items>
                    <x:Grid ID="Grid1" runat="server" Title="被考评人名单" Width="730px" PageSize="20" ShowBorder="true"
                        ...
                        <Columns>
                            ...
                            <x:WindowField TextAlign="Center" Width="80px" WindowID="Window_CheckEvaluateTable" Text="审核"
                                ToolTip="审核考评表" Title="审核" IFrameUrl="iframe_CheckEvaluateTabler.aspx" DataIFrameUrlFields="ID,Name,Status"
                                DataIFrameUrlFormatString="iframe_CheckEvaluateTable.aspx?id={0}&name={1}&status={2}" />
                        </Columns>
                    </x:Grid>
