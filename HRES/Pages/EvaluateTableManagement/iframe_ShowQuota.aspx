                    ...
                    <x:Panel ID="Panel3" runat="server" BodyPadding="5px" ShowBorder="false" ShowHeader="false"
                        ...
                        <Items>
                            ...
                            <x:SimpleForm ID="SimpleForm1" runat="server" BodyPadding="5px" Title="SimpleForm" ShowHeader="false">
                                <Items>
                                    <x:TextArea ID="TextArea1" runat="server" Height="50px" Label="优" Text="">
                                    </x:TextArea>
                                    <x:TextArea ID="TextArea2" runat="server" Height="50px" Label="良" Text="">
                                    </x:TextArea>
                                    <x:TextArea ID="TextArea3" runat="server" Height="50px" Label="中" Text="">
                                    </x:TextArea>
                                    <x:TextArea ID="TextArea4" runat="server" Height="50px" Label="差" Text="">
                                    </x:TextArea>
                                </Items>
                            </x:SimpleForm>
                        </Items>
