<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="iframe_Comment.aspx.cs" Inherits="HRES.Pages.Common.iframe_Comment" %>
        ...
        <x:Panel ID="Panel1" runat="server" BodyPadding="0px" ShowBorder="true" ShowHeader="false" 
            ...
            <Items>
                ...
                <x:SimpleForm ID="SimpleForm1" runat="server" BodyPadding="5px" Title="SimpleForm" ShowBorder="false" ShowHeader="false">
                    <Items>
                        <x:TextArea ID="TextArea_Comment" runat="server" Height="50px" Label="请输入审核意见" Text="">
                        </x:TextArea>
                    </Items>
                </x:SimpleForm>
            </Items>
